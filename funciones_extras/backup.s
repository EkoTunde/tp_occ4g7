    ...
    sonDigitos:
        .fnstart
            ...
            cicloSonDigitos:
                ...
                cmp r3, #0
                beq finSonDigitos       // Si cadena[i] == nul -> terminamos de iterar, eran todos digitos
                ...
                add r3, #1              // i++
                bal cicloSonDigitos     // siguiente iteracion
    ...
    pedirX:
        .fnstart
            ...
            cicloPedirX:
                ...
                ldr r0, =inputUsuario
                bl sonDigitos       // r1 <- si en el input solo hay numeros
    ...
    */
    acertoDisparoY:
        .fnstart
            ...
            ldr r2, =posCuerdaY
            ldr r3, [r1]            // r2 <- posCuerdaY

            cmp r0, r3
            beq acertoX             // Si el numeroIngresado == posCuerdaY -> acerto
    ...
    */
    disparo:
        .fnstart
            ...
            bl acertoDisparoX   // r1 <- si acerto o no con la posicion x

            cmp r1, #0
            beq noAcertoDisparo

            bl pedirY           // r0 <- el numero que ingreso el usuario
            bl acertoDisparoY   // r1 <- si acerto o no con la posicion y
