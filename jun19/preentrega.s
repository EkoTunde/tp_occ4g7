...
.text
    ...
    *
    */
    informarLetraRepetida:
        .fnstart
            push {r0, r1, r2, lr}

            // Si el flag de repitioLetra esta encendido,
            // informar al usuario que esa letra ya fue ingresada
            ldr r0, =repitioLetra
            ldrb r0, [r0]

            cmp r0, #0
            beq finInformarLetraRepetida

            ldr r1, =msjPorFavorNoRepitasLetras
            ldr r2, =lenMsjPorFavorNoRepitasLetras
            bl imprimirLinea

            finInformarLetraRepetida:
                // Apagar flag repitioLetra
                ldr r0, =repitioLetra
                mov r1, #0
                strb r1, [r0]
    ...
    */
    ...
    /**
    *   Determina si el usuario ingreso una letra o una palabra,
    *   ejecuta las subrutinas que dependen de si lo ingresado 
    *   es correcto o no para cada caso y retorna uno de los 
    *   siguiente resultados:
    *       - 0: acerto letra
    *       - 1: acerto palabra
    *       - 2: 
    *   --------------------------------------------------------
    *   Salida r0: resultado del proceso.
    */
    procesarDatos:
        .fnstart
            push {r0, r1, r2, lr}
            ...
            usuarioArriesgoPalabra:
                ...
                cmp r0, #1
                bne quitarTodasLasVidas // Si no acerto, quitar todas las vidas
            ...
            usuarioNoAcertoLetra:
                ...
                // restar una vida porque no acerto la letra
                bl quitarVida
    ...
    */
    jugar:
        .fnstart
            ...
            // Si vidasRestantes > 0 -> que continue el juego
            cmp r0, #0 
            bgt finJugar
    ...
    elegirNumero:
        .fnstart
            ...
            cicloElegirNumero:
                ...
                cmp r1, #1 
                blt cicloElegirNumero   // Si num < 1 -> volvemos a intentar

                cmp r1, #20 
                bgt cicloElegirNumero   // Si num > 20 -> volvemos a intentar

                ldr r0, =numeroPalabraElegida
                str r1, [r0]                        // Guardamos el numero en numeroPalabraElegida
